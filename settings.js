...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "YOUR_SESSION_ID","7BYSALJA#ix-by6uzGXc23bzsOeM4WLobQXpKeaphDmWYRHjFyK0"// Add your session id
PREFIX: process.env.PREFIX || ".",
OWNER_NUMBER: process.env.OWNER_NUMBER || "Renan bot",
